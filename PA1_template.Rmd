...
The `r maxInterval`th interval is the five-minute interval which contains, the maximum number of steps (on average across all days in the data set), with `r round(maxValue,0)`.
